    ...
    return (
        <div className='flex flex-col items-center justify-center pt-10 pb-10 bg-zinc-300'>
            ...
            <div className='md:px-20'>
                ...
                <p className='text-justify text-lg'><spam className='text-segundo-tema-site text-xl drop-shadow-dark1 text-xl'>Turismo de saúde</spam><br /><br />
